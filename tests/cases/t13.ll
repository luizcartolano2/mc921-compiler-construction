...
@".str.0" = global [10 x i32] [i32 5, i32 3, i32 7, i32 8, i32 4, i32 1, i32 9, i32 2, i32 0, i32 6]
@".str.1" = constant [33 x i8] c"Sorted list in ascending order: \00"
@".str.2" = constant [2 x i8] c" \00"
@".str.3" = constant [23 x i8] c"assertion_fail on 18:5\00"
define i32 @"main"() 
{
"%entry":
  %"v" = alloca [10 x i32]
...
@".fmt.1" = internal constant [3 x i8] c"%d\00"
@".fmt.2" = internal constant [3 x i8] c"%s\00"
@".fmt.3" = internal constant [2 x i8] c"\0a\00"
@".fmt.4" = internal constant [3 x i8] c"%s\00"