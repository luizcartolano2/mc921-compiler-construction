...
@".str.0" = constant [8 x i8] c"Matrix:\00"
@".str.1" = constant [3 x i8] c"  \00"
@".str.2" = constant [25 x i8] c"Transpose of the matrix:\00"
define i32 @"main"() 
{
"%entry":
  %"a" = alloca [10 x [10 x i32]]
  %"transpose" = alloca [10 x [10 x i32]]
  %"i" = alloca i32
  %"j" = alloca i32
  store i32 0, i32* %"i"
  br label %"%4"
...
@".fmt.1" = internal constant [2 x i8] c"\0a\00"
@".fmt.2" = internal constant [3 x i8] c"%d\00"
@".fmt.3" = internal constant [3 x i8] c"%s\00"
@".fmt.4" = internal constant [2 x i8] c"\0a\00"
@".fmt.5" = internal constant [3 x i8] c"%s\00"
@".fmt.6" = internal constant [2 x i8] c"\0a\00"
@".fmt.7" = internal constant [3 x i8] c"%d\00"
@".fmt.8" = internal constant [3 x i8] c"%s\00"
@".fmt.9" = internal constant [2 x i8] c"\0a\00"